...
public class RecalcStrategyTest {
  ...
  public void testPopulationChangeRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("PopulationChangeRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testRechargeEmissionsRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("RechargeEmissionsRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testEolEmissionsRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("EolEmissionsRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testConsumptionRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("ConsumptionRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testSalesRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("SalesRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testRetireRecalcStrategyRejectsWrongEngineType() {
    ...
    assertTrue(exception.getMessage().contains("RetireRecalcStrategy requires a SingleThreadEngine"));
  }
  ...
  public void testStrategiesImplementRecalcInterface() {
    ...
    RecalcStrategy rechargeStrategy = new RechargeEmissionsRecalcStrategy(testScope);
    RecalcStrategy eolStrategy = new EolEmissionsRecalcStrategy(testScope);
    RecalcStrategy retireStrategy = new RetireRecalcStrategy(testScope);
