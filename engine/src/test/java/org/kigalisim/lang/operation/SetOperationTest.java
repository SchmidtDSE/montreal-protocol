...
public class SetOperationTest {
  ...
  public void testExecuteWithDuring() {
    ...
    Operation yearOperation = new PreCalculatedOperation(new EngineNumber(BigDecimal.valueOf(2020), ""));
  ...
  public void testExecuteWithDuringNotApplying() {
    ...
    EngineNumber result = engine.getStream("manufacture");
    assertEquals(BigDecimal.ZERO, result.getValue(), "Stream value should not be set when during doesn't apply");
  ...
  public void testExecuteWithComplexValueOperation() {
    ...
    // Verify the stream was set in the engine
    EngineNumber result = engine.getStream("manufacture");
    assertEquals(BigDecimal.valueOf(42), result.getValue(), "Stream value should be calculated and set correctly");
    assertEquals("kg", result.getUnits(), "Stream units should be set correctly");
  }
}