...
[ ! -e third_party/prism-tomorrow.min.css ] && wget https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism-tomorrow.min.css -O third_party/prism-tomorrow.min.css
[ ! -e third_party/prism-core.min.js ] && wget https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/components/prism-core.min.js -O third_party/prism-core.min.js
[ ! -e third_party/prism-autoloader.min.js ] && wget https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/plugins/autoloader/prism-autoloader.min.js -O third_party/prism-autoloader.min.js
