ace.define("ace/mode/qubectalk", [
  ...
  const QubecTalkHighlightRules = function () {
    ...
    const commandKeywords = "across|as|at|by|cap|change|charge|during|enable|eol|floor|for|from|" +
      "get|in|initial|modify|of|recharge|recover|replace|retire|reuse|set|simulate|then|to|" +
      "trials|using|with";
